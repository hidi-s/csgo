...
import hashlib
# from flask.signals import password_reset, reset_password_instructions_sent
# from flask.utils import send_mail, md5, encrypt_password, url_for_security, \
